  ...
  <div class="max-w-7xl mx-auto px-4">
    <div class="flex justify-between items-center py-4">
      ...
      <nav class="hidden md:flex space-x-8 items-center">
        <a href="../user/dashboard.php" class="text-gray-700 hover:text-orange-600 font-medium transition-colors">Home</a>
        <a href="../user/all_events.php" class="text-gray-700 hover:text-orange-600 font-medium transition-colors">All Events</a>
        <a href="../user/upcoming.php" class="text-gray-700 hover:text-orange-600 font-medium transition-colors">Upcoming</a>
        ...
        <div class="relative">
          ...
          <div id="cat-menu" class="absolute hidden bg-white shadow-lg rounded-lg mt-2 w-40">
            <a href="../user/festival.php" class="block px-4 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-600">Festival</a>
            <a href="../user/tech_events.php" class="block px-4 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-600">Tech</a>
            <a href="../user/cultural_events.php" class="block px-4 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-600">Cultural</a>
          </div>
        </div>
         <a href="my_bookings.php" class="text-gray-700 hover:text-orange-600 font-medium transition-colors">My Bookings</a>
        <a href="../user/organize.php" class="text-gray-700 hover:text-orange-600 font-medium transition-colors">Organize</a>
      </nav>
