...
<div class="container mx-auto px-4 py-8">
  <div class="text-center mb-12">
    ...
    <p class="text-xl text-black opacity-90">Explore cultural, festivals, sports, and more</p>
  </div>
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
    <?php if ($res->num_rows > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p class="text-center text-gray-600 col-span-3">No events available at the moment.</p>
    <?php endif; ?>
    <?php $stmt->close(); ?>
  </div>
</div>
