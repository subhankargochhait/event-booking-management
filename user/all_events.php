...
<head>
  ...
  <title>All Categories Events</title>
...
<div class="container mx-auto px-4 py-8">
  <div class="text-center mb-12">
    <h1 class="text-5xl font-bold text-black mb-4">🌍 All Events</h1>
    <p class="text-xl text-black opacity-90">Browse through Upcoming, Festival, Tech, and Cultural events</p>
  </div>

  <?php
  // Fetch ALL active events regardless of category
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
    <?php if ($res->num_rows > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p class="text-center text-gray-600 col-span-3">No events available right now.</p>
    <?php endif; ?>
    <?php $stmt->close(); ?>
  </div>
</div>
